...
const (
	...
	// DefaultTelegramNotifyTimeout 알림 발송 요청 시 대기열이 가득 찼을 때 대기하는 최대 시간 (Backpressure)
	DefaultTelegramNotifyTimeout = 5 * time.Second
	...
	// 기존 DefaultTelegramNotifyTimeout(5s)은 큐잉 대기 시간으로만 사용합니다.
