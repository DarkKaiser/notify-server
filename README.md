...
| `notify_api.cors.allow_origins` | CORS 허용 도메인 목록           | 아니오           |
...
```bash
curl -X POST "http://localhost:2443/api/v1/notifications" \
  -H "Content-Type: application/json" \
  -H "X-App-Key: your-secret-key-here" \
  -d '{
